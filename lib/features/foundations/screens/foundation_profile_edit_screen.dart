...
class _PublicHeroPlaceholder extends StatelessWidget {
  ...
  const _PublicHeroPlaceholder({required this.text, required this.icon});
...
class _PublicLogoPlaceholder extends StatelessWidget {
  final String text;

  const _PublicLogoPlaceholder({required this.text});
...
class _PublicEditBlock extends StatelessWidget {
  final String title;
  final Widget child;

  const _PublicEditBlock({required this.title, required this.child});
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              // Layout grid untuk desktop, kolom untuk mobile
              if (isDesktop)
                Row(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [
                  ...
                  Stack(
                    children: [
                      _uploadedLogoUrl != null
                          ...
                          : _PublicLogoPlaceholder(text: initials),
                      if (isEditable)
                        Positioned(
                          bottom: 0,
                          right: 0,
                  ...
                  Expanded(
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          'Pilih gambar berformat JPG atau PNG dengan aspek rasio 1:1 (kotak/lingkaran) maksimal ukuran 2MB.',
          ...
          children: [
            ...
            _PublicEditBlock(
              ...
              child: TextFormField(
                ...
                decoration: InputDecoration(
                  hintText: 'Masukkan nama resmi yayasan...',
            ...
            _PublicEditBlock(
              ...
              child: TextFormField(
                ...
                maxLines: 8,
                decoration: InputDecoration(
                  hintText: 'Tuliskan deskripsi lengkap, sejarah, visi misi, atau informasi kontak dan nomor rekening donasi yayasan...',
                  border: OutlineInputBorder(borderRadius: BorderRadius.circular(8)),
                ),
              ),
            ),
